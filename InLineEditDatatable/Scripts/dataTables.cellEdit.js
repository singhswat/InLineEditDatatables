...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        ...
        case "list":
            ...
            input.html = "<select style='width: 50px !important; min-width: 50px; max-width: 50px;'  class='" + inputCss + "' onchange='$(this).updateEditableCell(this);'>";
        ...
        case "ad":
            //  alert("ad");
            input.html = "<div class=ui-widget><input style='width:300px;' placeholder='Assign portal registered users only' id='ejbeatycelledit' onfocusout='$(this).updateEditableCell(this)' class='" + inputCss + "' value='" + oldValue + "'></input></div>";
            // input.html="<div class=ui-widget>"<input id='ejbeatycelledit' class='" + inputCss + "' onfocusout='$(this).updateEditableCell(this)' value='" + oldValue + "'></input></div>"
            break;
        ...
        case "datepicker-confirm":
            ...
            if (oldValue != '')
                input.html = "<div id='selectedArea'><input  id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "'   value='" + oldValue + "'></input>";
            else
                input.html = "<div id='selectedArea'><input id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "'   value='" + oldValue + "'></input>";
            setTimeout(function () {
                var self = jQuery('#ejbeatycelledit').datepicker(
                    {
                        ...
                        onClose: function () {
                            ...
                            if ($(event.delegateTarget).hasClass('ui-datepicker-close')) {
                                $(this).val('');
                                newValue = '';
                                $(this).updateEditableCellIFNull(this);
                            }
                        }
                    }).datepicker('show').datepicker({ autoClose: true });
                //$('input[name="fieldName"]').datepicker({ autoClose: true });
            }, 20);
            break;
        case "text-confirm": // text input w/ confirm
            input.html = "<input size=10 id='ejbeatycelledit' class='" + inputCss + "' value='" + oldValue + "'></input>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Confirm</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Cancel</a> ";
            break;
        ...
        default: // text input
            input.html = "<input size=10 id='ejbeatycelledit' class='" + inputCss + "' onfocusout='$(this).updateEditableCell(this)' value='" + oldValue + "'></input>";
            break;
    }
    return input;
}
